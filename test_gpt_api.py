...
def main():
    ...
    # Initialize API with new conversation (save_previous_response_id=True, no previous_response_id)
    print("\n📝 Initializing GPTAPI with new conversation...")
    print("   - save_previous_response_id: True")
    print("   - previous_response_id: None (new conversation)")
    
    try:
        api = GPTAPI(
            model="gpt-4o-2024-08-06",
            save_previous_response_id=True,
    ...
    for i, prompt in enumerate(prompts, 1):
        ...
        try:
            ...
            if api.save_previous_response_id and api.previous_response_id:
