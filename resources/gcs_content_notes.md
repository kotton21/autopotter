#Extra notes on gcs content:

-All the photos in the gcs video_uploads folder are from freshly finished greenware clay prints, and their names correspond to the print timelapse video that was just completed.
...
- music_uploads contains music which should be used in the background of the output movie.
- completed_works contains photos and videos of individual pieces after printing, glazing, and firing the clay.
- work_in_progress contains photos and videos of prints in various stages of the clay production process.
- printer_assembly contains photos and videos of the assembly process of the robot itself.
